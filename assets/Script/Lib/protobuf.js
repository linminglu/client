...
function fetch(filename, options, callback) {
    ...
    try {
        cc.loader.load(filename, function (err, proto) {
	    	if (err) {
	            console.log("protobuf.load 读取" + filename + "失败");
	            return null;
	        }
		...
		console.log("protobuf.load 读取" + filename + "异常");
        return null;
    }
}
...
Type.prototype.encode = function encode_setup(message, writer) {
    ...
    return setup.encode(message, writer); // overrides this method
};
