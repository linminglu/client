...
@ccclass
export default class RecordTypeItem4 extends cc.Component {
    ...
    recordGameTypeDataFun(data){
        ...
        lblArr[13].getComponent(cc.Label).string = RecordController.instance.getRecordint2Float(data.winOrLose).toString();
        lblArr[14].getComponent(cc.Label).string = RecordController.instance.getRecordint2Float(data.pumpMoney).toString();
        for(let i = 2; i < 13 ; i++){
